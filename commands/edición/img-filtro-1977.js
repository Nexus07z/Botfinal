...
module.exports = {
    name: "img-filtro-1977",
    alias: ["imgf1977"],
    use: "<Respuesta>",
    desc: "Convierte una imagen con filtro 1977.",
    ...
    start: async(killua, m, { command, prefix, quoted, mime, text }) => {
        ...
        if (/image/.test(mime)) {
            try {
                ...
                await killua.sendFile(m.from, global.apilol("lol", "/filter/1977", { img: link }, "apikey"), "", m)
            ...
            try {
                ...
                await killua.sendFile(m.from, global.apilol("lol", "/filter/1977", { img: isUrl(text)[0] }, "apikey"), "", m)
