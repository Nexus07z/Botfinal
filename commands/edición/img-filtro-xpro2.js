...
module.exports = {
    name: "img-filtro-xpro2",
    alias: ["imgfxpro2"],
    use: "<Respuesta>",
    desc: "Convierte una imagen con filtro xpro2.",
    ...
    start: async(killua, m, { command, prefix, quoted, mime, text }) => {
        ...
        if (/image/.test(mime)) {
            try {
                ...
                await killua.sendFile(m.from, global.apilol("lol", "/filter/xpro2", { img: link }, "apikey"), "", m)
            ...
            try {
                ...
                await killua.sendFile(m.from, global.apilol("lol", "/filter/xpro2", { img: isUrl(text)[0] }, "apikey"), "", m)
