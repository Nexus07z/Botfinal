...
module.exports = {
    ...
    alias: ["sepia"],
    use: "<Respuesta>",
    desc: "Convierte una imagen en sepia.",
    ...
    start: async(killua, m, { command, prefix, quoted, mime, text }) => {
        ...
        if (/image/.test(mime)) {
            try {
                ...
                await killua.sendFile(m.from, global.apilol("lol", "/creator1/sepia", { img: link }, "apikey"), "", m)
            ...
            try {
                ...
                await killua.sendFile(m.from, global.apilol("lol", "/creator1/sepia", { img: isUrl(text)[0] }, "apikey"), "", m)
