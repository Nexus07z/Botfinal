module.exports = {
    ...
    start: async(killua, m, { command, prefix, text }) => {  
        ...
        try {
            ...
            await killua.sendFile(m.from, `https://api.lolhuman.xyz/api/ttp2?apikey=${global.apilol}&text=${text}`,  "", m, { asSticker: true, author: config.exif.author, packname: config.exif.packname, categories: ['😄','😊'] })
