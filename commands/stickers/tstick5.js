module.exports = {
    ...
    start: async(killua, m, { command, prefix, text }) => {  
        ...
        try {
            ...
            await killua.sendFile(m.from, global.apilol("lol", "/ttp5", { text: text }, "apikey"), "", m, { asSticker: true, author: config.exif.author, packname: config.exif.packname, categories: ['😄','😊'] })
